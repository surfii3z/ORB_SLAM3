...
if("TRUE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /home/jy/orb_slam_ws/ORB_SLAM3/ros/src/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /home/jy/orb_slam_ws/ORB_SLAM3/ros/devel/.private/cv_bridge)
  ...
  set(cv_bridge_INSTALL_PREFIX /home/jy/orb_slam_ws/ORB_SLAM3/ros/install)
...
if(NOT "/home/jy/orb_slam_ws/ORB_SLAM3/ros/src/cv_bridge/include;/usr/local/include;/usr/local/include/opencv " STREQUAL " ")
  set(cv_bridge_INCLUDE_DIRS "")
  set(_include_dirs "/home/jy/orb_slam_ws/ORB_SLAM3/ros/src/cv_bridge/include;/usr/local/include;/usr/local/include/opencv")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jy/orb_slam_ws/ORB_SLAM3/ros/src/cv_bridge/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jy/orb_slam_ws/ORB_SLAM3/ros/devel/.private/cv_bridge/lib;/home/jy/orb_slam_ws/ORB_SLAM3/ros/devel/lib;/opt/ros/melodic/lib)
